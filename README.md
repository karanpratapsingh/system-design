...
The primary difference between synchronous and asynchronous replication is how the data is written to the replica. In asynchronous replication, data is written to primary storage and the replica simultaneously. 
